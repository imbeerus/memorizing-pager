...
[![Download](https://img.shields.io/badge/Download-v.1.1.3-blue.svg)](https://github.com/kekc42/memorizing-pager#download)
...
```
dependencies {
	compile 'com.github.kekc42:memorizing-pager:1.1.3'
}
```
or Maven:
```
...
[2]: https://github.com/kekc42/memorizing-pager/releases/download/1.1.3/memorizingpager-sources.jar