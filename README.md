...
[![Download](https://img.shields.io/badge/Download-v.1.0.0-blue.svg)](https://github.com/kekc42/memorizing-pager#download)
...
```
dependencies {
	compile 'com.github.kekc42:memorizing-pager:1.0.0'
}
```
or Maven:
```
...
[2]: https://github.com/kekc42/memorizing-pager/releases/download/1.0.0/memorizingpager-sources.jar
